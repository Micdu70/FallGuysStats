...
namespace FallGuysStats {
    ...
    public class LevelStats {
        public static Dictionary<string, LevelStats> ALL = new Dictionary<string, LevelStats>(StringComparer.OrdinalIgnoreCase) {
            ...
            { "round_satellitehoppers_almond",    new LevelStats("Cosmic Highway", LevelType.Race, false, false, 8, Properties.Resources.round_cosmic_highway_icon) },
            { "round_gauntlet_02",                new LevelStats("Dizzy Heights", LevelType.Race, false, false, 1, Properties.Resources.round_dizzy_heights_icon) },
            { "round_door_dash",                  new LevelStats("Door Dash", LevelType.Race, false, false, 1, Properties.Resources.round_door_dash_icon) },
            { "round_iceclimb",                   new LevelStats("Freezy Peak", LevelType.Race, false, false, 3, Properties.Resources.round_freezy_peak_icon) },
            { "round_dodge_fall",                 new LevelStats("Fruit Chute", LevelType.Race, false, false, 1, Properties.Resources.round_fruit_chute_icon) },
            { "round_see_saw_360",                new LevelStats("Full Tilt", LevelType.Race, false, false, 6, Properties.Resources.round_full_tilt_icon) },
            { "round_chompchomp",                 new LevelStats("Gate Crash", LevelType.Race, false, false, 1, Properties.Resources.round_gate_crash_icon) },
            { "round_gauntlet_01",                new LevelStats("Hit Parade", LevelType.Race, false, false, 1, Properties.Resources.round_hit_parade_icon) },
            { "round_gauntlet_04",                new LevelStats("Knight Fever", LevelType.Race, false, false, 2, Properties.Resources.round_knight_fever_icon) },
            ...
            { "round_shortcircuit",               new LevelStats("Short Circuit", LevelType.Race, false, false, 4, Properties.Resources.round_short_circuit_icon) },
            { "round_skeefall",                   new LevelStats("Ski Fall", LevelType.Race, false, false, 3, Properties.Resources.round_ski_fall_icon) },
            { "round_gauntlet_06",                new LevelStats("Skyline Stumble", LevelType.Race, false, false, 4, Properties.Resources.round_skyline_stumble_icon) },
            { "round_lava",                       new LevelStats("Slime Climb", LevelType.Race, false, false, 1, Properties.Resources.round_slime_climb_icon) },
            { "round_gauntlet_10_almond",         new LevelStats("Space Race", LevelType.Race, false, false, 8, Properties.Resources.round_space_race_icon) },
            { "round_short_circuit_2_symphony_launch_show", new LevelStats("Speed Circuit", LevelType.Race, false, false, 7, Properties.Resources.round_speed_circuit_icon) },
            { "round_slide_chute",                new LevelStats("Speed Slider", LevelType.Race, false, false, 9, Properties.Resources.round_speed_slider_icon) },
            { "round_starlink_almond",            new LevelStats("Starchart", LevelType.Race, false, false, 8, Properties.Resources.round_starchart_icon) },
            { "round_slimeclimb_2",               new LevelStats("The Slimescraper", LevelType.Race, false, false, 4, Properties.Resources.round_the_slimescraper_icon) },
            { "round_gauntlet_03",                new LevelStats("The Whirlygig", LevelType.Race, false, false, 1, Properties.Resources.round_the_whirlygig_icon) },
            { "round_tip_toe",                    new LevelStats("Tip Toe", LevelType.Race, false, false, 1, Properties.Resources.round_tip_toe_icon) },
            { "round_gauntlet_09_symphony_launch_show", new LevelStats("Track Attack", LevelType.Race, false, false, 7, Properties.Resources.round_track_attack_icon) },
            { "round_gauntlet_07",                new LevelStats("Treetop Tumble", LevelType.Race, false, false, 5, Properties.Resources.round_treetop_tumble_icon) },
            { "round_gauntlet_05",                new LevelStats("Tundra Run", LevelType.Race, false, false, 3, Properties.Resources.round_tundra_run_icon) },
            { "round_wall_guys",                  new LevelStats("Wall Guys", LevelType.Race, false, false, 2, Properties.Resources.round_wall_guys_icon) },

            { "round_fruitpunch_s4_show",         new LevelStats("Big Shots", LevelType.Survival, false, false, 4, Properties.Resources.round_big_shots_icon) },
            { "round_blastballruins",             new LevelStats("Blastlantis", LevelType.Survival, false, false, 9, Properties.Resources.round_blastlantis_icon) },
            { "round_block_party",                new LevelStats("Block Party", LevelType.Survival, false, false, 1, Properties.Resources.round_block_party_icon) },
            { "round_hoverboardsurvival_s4_show", new LevelStats("Hoverboard Heroes", LevelType.Survival, false, false, 4, Properties.Resources.round_hoverboard_heroes_icon) },
            { "round_hoverboardsurvival2_almond", new LevelStats("Hyperdrive Heroes", LevelType.Survival, false, false, 8, Properties.Resources.round_hyperdrive_heroes_icon) },
            { "round_jump_club",                  new LevelStats("Jump Club", LevelType.Survival, false, false, 1, Properties.Resources.round_jump_club_icon) },
            { "round_tunnel",                     new LevelStats("Roll Out", LevelType.Survival, false, false, 1, Properties.Resources.round_roll_out_icon) },
            { "round_snowballsurvival",           new LevelStats("Snowball Survival", LevelType.Survival, false, false, 3, Properties.Resources.round_snowball_survival_icon) },
            { "round_robotrampage_arena_2",       new LevelStats("Stompin' Ground", LevelType.Survival, false, false, 5, Properties.Resources.round_stompin_ground_icon) },
            { "round_spin_ring_symphony_launch_show", new LevelStats("The Swiveller", LevelType.Survival, false, false, 7, Properties.Resources.round_the_swiveller_icon) },

            { "round_airtime",                    new LevelStats("Airtime", LevelType.Hunt, false, false, 6, Properties.Resources.round_airtime_icon) },
            { "round_bluejay",                    new LevelStats("Bean Hill Zone", LevelType.Hunt, false, false, 7, Properties.Resources.round_bean_hill_zone_icon) },
            { "round_hoops_revenge_symphony_launch_show", new LevelStats("Bounce Party", LevelType.Hunt, false, false, 7, Properties.Resources.round_bounce_party_icon) },
            { "round_king_of_the_hill",           new LevelStats("Bubble Trouble", LevelType.Hunt, false, false, 5, Properties.Resources.round_bubble_trouble_icon) },
            { "round_1v1_button_basher",          new LevelStats("Button Bashers", LevelType.Hunt, false, false, 4, Properties.Resources.round_button_bashers_icon) },
            { "round_ffa_button_bashers_squads_almond", new LevelStats("Frantic Factory", LevelType.Hunt, false, false, 8, Properties.Resources.round_frantic_factory_icon) },
            { "round_slippy_slide",               new LevelStats("Hoop Chute", LevelType.Hunt, false, false, 9, Properties.Resources.round_hoop_chute_icon) },
            { "round_hoops_blockade_solo",        new LevelStats("Hoopsie Legends", LevelType.Hunt, false, false, 2, Properties.Resources.round_hoopsie_legends_icon) },
            { "round_follow-the-leader_s6_launch",new LevelStats("Leading Light", LevelType.Hunt, false, false, 6, Properties.Resources.round_leading_light_icon) },
            { "round_penguin_solos",              new LevelStats("Pegwin Pool Party", LevelType.Hunt, false, false, 5, Properties.Resources.round_pegwin_pool_party_icon) },
            ...
            { "round_egg_grab",                   new LevelStats("Egg Scramble", LevelType.Team, false, false, 1, Properties.Resources.round_egg_scramble_icon) },
            { "round_egg_grab_02",                new LevelStats("Egg Siege", LevelType.Team, false, false, 2, Properties.Resources.round_egg_siege_icon) },
            { "round_fall_ball_60_players",       new LevelStats("Fall Ball", LevelType.Team, false, false, 1, Properties.Resources.round_fall_ball_icon) },
            { "round_ballhogs",                   new LevelStats("Hoarders", LevelType.Team, false, false, 1, Properties.Resources.round_hoarders_icon) },
            { "round_hoops",                      new LevelStats("Hoopsie Daisy", LevelType.Team, false, false, 1, Properties.Resources.round_hoopsie_daisy_icon) },
            { "round_jinxed",                     new LevelStats("Jinxed", LevelType.Team, false, false, 1, Properties.Resources.round_jinxed_icon) },
            { "round_chicken_chase",              new LevelStats("Pegwin Pursuit", LevelType.Team, false, false, 3, Properties.Resources.round_pegwin_pursuit_icon) },
            { "round_territory_control_s4_show",  new LevelStats("Power Trip", LevelType.Team, false, false, 4, Properties.Resources.round_power_trip_icon) },
            { "round_rocknroll",                  new LevelStats("Rock 'n' Roll", LevelType.Team, false, false, 1, Properties.Resources.round_rock_n_roll_icon) },
            ...
            { "wle_s10_orig_round_045_long",      new LevelStats("Floorless", LevelType.Race, true, false, 10, Properties.Resources.round_gauntlet_icon) },
            { "wle_s10_long_round_003",           new LevelStats("Fall Speedway", LevelType.Race, true, false, 10, Properties.Resources.round_gauntlet_icon) },
            { "wle_s10_long_round_004",           new LevelStats("Zig Zag Zoomies", LevelType.Race, true, false, 10, Properties.Resources.round_gauntlet_icon) },
            { "wle_s10_long_round_005",           new LevelStats("Terrabyte Trial", LevelType.Race, true, false, 10, Properties.Resources.round_gauntlet_icon) },
        ...
        public LevelStats(string levelName, LevelType type, bool isCreative, bool isFinal, int season, Image roundIcon) {
