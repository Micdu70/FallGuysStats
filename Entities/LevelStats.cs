...
namespace FallGuysStats {
    ...
    public class LevelStats {
        public static Dictionary<string, LevelStats> ALL = new Dictionary<string, LevelStats>(StringComparer.OrdinalIgnoreCase) {
            ...
            { "round_slimeclimb_2",               new LevelStats("The Slimescraper", LevelType.Race, false, 4) },
            { "round_gauntlet_06",                new LevelStats("Skyline Stumble", LevelType.Race, false, 4) },
            { "round_gauntlet_03",                new LevelStats("The Whirlygig", LevelType.Race, false, 1) },
            ...
            { "round_skeefall",                   new LevelStats("Ski Fall", LevelType.Race, false, 3) },
            ...
            { "round_hoverboardsurvival_s4_show", new LevelStats("Hoverboard Heroes", LevelType.SurvivalRace, false, 4) },
            { "round_hoverboardsurvival2_almond", new LevelStats("Hyperdrive Heroes", LevelType.SurvivalRace, false, 8) },
            ...
            { "round_tiptoefinale_almond",        new LevelStats("Tip Toe Finale", LevelType.Race, true, 8) },
            ...
            { "round_invisibeans",                new LevelStats("Sweet Thieves", LevelType.Invisibeans, false, 6) },
        };
