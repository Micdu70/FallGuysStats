...
namespace FallGuysStats {
    ...
    public class LevelStats {
        public static Dictionary<string, LevelStats> ALL = new Dictionary<string, LevelStats>(StringComparer.OrdinalIgnoreCase) {
            ...
            //S10 Creative Rounds
            { "wle_s10_orig_round_001", new LevelStats("BEANS AHOY!", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_002", new LevelStats("AIRBORNE ANTICS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_003", new LevelStats("SCYTHES & ROUNDABOUTS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_004", new LevelStats("CARDIO RUNNERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_005", new LevelStats("FAN FLINGERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_006", new LevelStats("UPHILL STRUGGLE", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_007", new LevelStats("SPINNER SPRINT", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_008", new LevelStats("LANE CHANGERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_009", new LevelStats("GENTLE GAUNTLET", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_010", new LevelStats("SQUARE UP", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_011", new LevelStats("SLIDE SHOWDOWN", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_012", new LevelStats("UP & DOWN", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_013", new LevelStats("CHOO CHOO CHALLENGE", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_014", new LevelStats("RUNNER BEANS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_015", new LevelStats("DISC DASHERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_016", new LevelStats("TWO FACED", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_017", new LevelStats("BELLYFLOP BATTLERS", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_018", new LevelStats("APPLES & ORANGES", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_019", new LevelStats("BLUEBERRY BOMBARDMENT", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_020", new LevelStats("CHUTING STARS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_021", new LevelStats("SLIMY SLOPES", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_022", new LevelStats("CIRCUIT BREAKERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_023", new LevelStats("WINDING WALKWAYS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_024", new LevelStats("WOOSELEUM", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_025", new LevelStats("MOUNT BOOM", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_026", new LevelStats("HYPERLINK HIJINKS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_027", new LevelStats("FAN FROLICS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_028", new LevelStats("WINDMILL ROAD", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_029", new LevelStats("CONVEYOR CLASH", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_030", new LevelStats("MEGA MONUMENT", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_031", new LevelStats("TRANSFER TURNPIKE", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_032", new LevelStats("FORTRESS FROLICS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_033", new LevelStats("SUPER DOOR DASH", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_034", new LevelStats("SPIRAL OF WOO", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_035", new LevelStats("TORNADO TRIAL", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_036", new LevelStats("HOPSCOTCH HAVOC", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_037", new LevelStats("BEAT BOUNCERS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_038", new LevelStats("BLUNDER BRIDGES", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_039", new LevelStats("INCLINE REWIND", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_040", new LevelStats("PRISMATIC PARADE", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_041", new LevelStats("SWEPT AWAY", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_042", new LevelStats("BALANCING ACT", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_043", new LevelStats("TROUBLE TOWER", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_044", new LevelStats("SERPENT SLALOM", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_045", new LevelStats("FLOORLESS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_046", new LevelStats("IN THE CLOUD", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_047", new LevelStats("DOWNSTREAM DUEL", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_orig_round_048", new LevelStats("LOST PALACE", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_001", new LevelStats("DIGI TREK", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_002", new LevelStats("SHORTCUT LINKS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_003", new LevelStats("UPLOAD HEIGHTS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_004", new LevelStats("PARKOUR PANIC", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_005", new LevelStats("DATA STREAMS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_006", new LevelStats("GIGABYTE GAUNTLET", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_007", new LevelStats("CUBE CORRUPTION", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_008", new LevelStats("WHAM BAM BOOM", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_009", new LevelStats("FIREWALL FINALE", LevelType.Race, true, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_010", new LevelStats("PIXEL HEARTS", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_011", new LevelStats("CYBER CIRCUIT", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) },
            { "wle_s10_round_012", new LevelStats("BOOM BLASTER TRIAL", LevelType.Race, false, 10, Properties.Resources.fallguys_icon) }
        };
