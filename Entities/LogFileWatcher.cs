...
namespace FallGuysStats {
    ...
    public class LogFileWatcher {
        ...
        private bool GetIsTeamVolleyfallRound(string roundName) {
        ...
        private bool ParseLine(LogLine line, List<RoundInfo> round, LogRound logRound) {
            ...
            if (Stats.InShow && logRound.Info == null && (index = line.Line.IndexOf("[HandleSuccessfulLogin] Selected show is", StringComparison.OrdinalIgnoreCase)) > 0) {
                ...
                logRound.Info = new RoundInfo {
                    ShowNameId = this.selectedShowId
                };
                ...
                bool isTeamVolleyfallRound = GetIsTeamVolleyfallRound(logRound.Info.Name);
                ...
                logRound.Info.Playing = false;
            } else if (logRound.Info != null && line.Line.IndexOf("Changing local player state to: SpectatingEliminated", StringComparison.OrdinalIgnoreCase) > 0) {
                ...
                if (line.Line.IndexOf("[GameStateMachine] Replacing FGClient.StatePrivateLobby with FGClient.StateMainMenu", StringComparison.OrdinalIgnoreCase) > 0) {
