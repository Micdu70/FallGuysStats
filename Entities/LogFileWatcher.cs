...
namespace FallGuysStats {
    ...
    public class LogFileWatcher {
        ...
        private bool IsRealFinalRound(string roundId, string showId) {
            if ((showId.StartsWith("show_wle_s10_") && showId.IndexOf("_srs", StringComparison.OrdinalIgnoreCase) != -1) || showId.StartsWith("wle_s10_player_round_") || showId.StartsWith("current_wle_") || showId.StartsWith("wle_s10_cf_round_")) { this.isCreatorMadeRoundsShow = true; return true; }
