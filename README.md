...
INFO: Date des données GeoLite2 utilisées => 01/08/2023
...
**Dernière version:** `v1.213` ~ 02/08/2023
...
### Il y a 0 bug génant connu dans la v1.213 de la "FE" (Frenchy Edition)
