...
INFO: Date des données GeoLite2 utilisées => 22/08/2023
...
**Dernière version:** `v1.216` ~ 24/08/2023
...
### Il y a 0 bug génant connu dans la v1.216 de la "FE" (Frenchy Edition)
