...
INFO: Date de la base de données IPinfo.io => 14/11/2023
...
**Dernière version:** `v1.229` ~ 15/11/2023
...
- ++Ajouté: Nom des nouvelles manches / émissions
- ++Changé: Base de données IPinfo.io datant du 14/11/2023


### Il y a 0 bug génant connu dans la v1.229 de la "FE" (Frenchy Edition)
...
## Changelog complet de la "FE" (Frenchy Edition)
  ...
  - `v1.224` ~ 05/10/2023
    - +Corrigé: Détection des manches non finales de "Hex-Anneau" pour l'émission "Ronde Hexathlon"
    - ++Changé: Base de données GeoLite2 datant du 06/10/2023

  - `v1.223` ~ 04/10/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 03/10/2023
  ...
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 22/09/2023

  - `v1.219` ~ 13/09/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 12/09/2023

  - `v1.218` ~ 07/09/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 06/09/2023

  - `v1.217` ~ 31/08/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 29/08/2023

  - `v1.216` ~ 24/08/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 22/08/2023

  - `v1.215` ~ 17/08/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 15/08/2023

  - `v1.214` ~ 09/08/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 08/08/2023

  - `v1.213` ~ 02/08/2023
  { Correction de bugs de la "FE" }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 01/08/2023
  ...
  - `v1.211` ~ 04/07/2023
  { Correction de bugs de la "FE" }
    - +Corrigé: Détection des manches finales pour la nouvelle émission du 04/07/2023 [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 04/07/2023

  - `v1.210` ~ 28/06/2023
  { Correction de bugs de la "FE" }
  { Cette version, bien que basée sur la Version Officielle (v1.210) datant du 28/06/2023, n'applique pas - par choix personnel - toutes les modifications de celle-ci }
    - ++Ajouté: Nom des nouvelles manches / émissions [Version Officielle]
    - ++Changé: Base de données GeoLite2 datant du 27/06/2023
